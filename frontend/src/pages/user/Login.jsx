...
import "./Login.css";
import { jwtDecode } from "jwt-decode"; // JWT 토큰 디코딩 해주는 라이브러리
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (accessToken) {
        ...
        const decoded = jwtDecode(accessToken); // JWT 토큰 디코딩
        const userRole = decoded.role; // 디코딩된 토큰에서 role 값 꺼내오기
      ...
      <div className="login-wrapper">
        <div className="login-content">
          <header className="logo-container">
            <img
              src="https://c.animaapp.com/JlqecQMn/img/sloweat-logo-1@2x.png"
              alt="Slow Eat 로고"
